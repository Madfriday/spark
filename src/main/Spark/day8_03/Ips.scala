...
//    val group = "g001"
//    //创建SparkConf
//    val conf = new SparkConf().setAppName("Ips").setMaster("local[2]")
//    //创建SparkStreaming，并设置间隔时间
//    val ssc = new StreamingContext(conf, Duration(5000))
//    val v1: Broadcast[Array[(Long, Long, String)]] = IpBroadCast.BroadCast_Ip(ssc, "d:/w.jar/ip/ip.txt")
//
//    //指定消费的 topic 名字
//    val topic = "r1"
//    //指定kafka的broker地址(sparkStream的Task直连到kafka的分区上，用更加底层的API消费，效率更高)
//    val brokerList = "node1:9092,slave1:9092,slave2:9092"
//
...
//        val cont1: RDD[Array[String]] = lines.map(_.split(" "))
//        CUtils.calculateincome(cont1)
//        CUtils.calculateItem(cont1)
//        CUtils.calculateZone(v1, cont1)
//
//        for (o <- offsetRanges) {
//          //  /g001/offsets/wordcount/0
